...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('preconsulta', function (Blueprint $table) {
            ...
            $table->string('motiv_uso_gaf', 255);         
            ...
            $table->string('motiv_uso_medicam', 255);         
            ...
            $table->string('motiv_limit_pantalla', 255);           
            ...
            $table->string('motiv_acti_libre', 255);         
            ...
            $table->string('motiv_bue_alimen', 255);        
            ...
            $table->string('motiv_soli_control', 255);          
